...
public class busSitCtg extends JFrame implements ActionListener{
...
boolean A1=false,A2=false,B1=false,B2=false,C1=false,C2=false,D1=false,D2=false,E1=false,E2=false,F1=false,F2=false,G1=false,G2=false,H=false;
	...
	public busSitCtg(String title, Rectangle r,User u,String d){
		super("BUS SIT CHITTAGONG TO DHAKA");
		this.count=0;
	...
	public void actionPerformed(ActionEvent a){
		...
		if(a.getSource()==b17){
				...
				String dsql2="SELECT `userName` from `bussitctg` Where sitNum IN ("+sitc+")";
				try{
				...
				String dsql = "UPDATE `bussitctg` SET `userName`='"+u.getU()+"',`contactNo`='"+u.getC()+"' WHERE sitNum IN ("+sitc+")";
			...
			try {
					...
					System.out.println(" ctg Sit....accepted");
			...
			try{
					...
					System.out.println("accepted");
						...
						setVisible(false);
				Ticket T2 = new Ticket("Ticket", new Rectangle(400, 50, 500, 450),u,"CTG TO DHK");
