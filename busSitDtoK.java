...
public class busSitDtoK extends JFrame implements ActionListener{
...
boolean A1=false,A2=false,B1=false,B2=false,C1=false,C2=false,D1=false,D2=false,E1=false,E2=false,F1=false,F2=false,G1=false,G2=false,H=false;
	...
	public busSitDtoK(String title, Rectangle r,User u,String d){
	...
	public void actionPerformed(ActionEvent a){
		...
		if(a.getSource()==b17){
				...
				String dsql2="SELECT `userName` from `bussitdtok` Where sitNum IN ("+sitc+")";
				try{
				...
				String dsql = "UPDATE `bussitdtok` SET `userName`='"+u.getU()+"',`contactNo`='"+u.getC()+"' WHERE sitNum IN ("+sitc+")";
			...
			try{
				...
				setVisible(false);
				Ticket T2 = new Ticket("Ticket", new Rectangle(400, 50, 500, 450),u,"Dhaka TO Khulna");
					}
